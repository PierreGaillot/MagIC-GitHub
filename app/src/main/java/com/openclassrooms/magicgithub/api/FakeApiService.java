...
public class FakeApiService implements ApiService {
    ...
    public void generateRandomUser() {
        // TODO: A modifier
        // 1 - Generate random Int.
        Random randomInt = new Random();
        // 2 - Get random user from #FAKE_USERS_RANDOM
        User randomUser = FAKE_USERS_RANDOM.get(randomInt.nextInt(FAKE_USERS_RANDOM.size()));
        // 3 - add the random user to #users
